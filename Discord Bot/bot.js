...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    ...
    .setAuthor("XO RP Server Status", "https://cdn.discordapp.com/attachments/580680574369398794/582249284825776148/logo_vinity_end.png")
    .setColor(0x2894C2)
  ...
  bot.on('ready',() => {
    ...
    bot.user.setActivity('XORP',{'url':'https://www.twitch.tv/RoqueTV','type':'STREAMING'});
